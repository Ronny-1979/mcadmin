...
const SCHEMA=[
  ...
  {k:'allow-inbound-script-debugging',l:'Eingehendes Script-Debugging',t:'bool',d:'Erlaubt /script debugger listen <port> — VS Code verbindet sich dann zum Server (empfohlen für Dedicated Server). Standard: aus'},
